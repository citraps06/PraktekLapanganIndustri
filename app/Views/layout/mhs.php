        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <a href="/login/logout" type="button" class="btn btn-default">
                    <i class="fas fa-power-off">&ensp;<?php echo session()->get('nama_mhs'); ?></i>
                </a>
                <li class="nav-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="/mahasiswa/index" class="d-block"><?php echo session()->get('nama_mhs'); ?></a>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url('/mahasiswa/daftar_coaching') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Daftar Coaching</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo base_url('/mahasiswa/status_coaching') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Status Coaching</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url('/mahasiswa/daftar_pli') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Ajukan Tempat</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo base_url('/mahasiswa/status_pli') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Status PLI</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url('/mahasiswa/berkas') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Berkas Magang</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo base_url('/mahasiswa/nilai_mhs') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Nilai Akhir</p>
                                    </a>
                                </li>
