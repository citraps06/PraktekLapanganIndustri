        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                <div class="login-wrap p-4 p-md-5">
                    <h3 class="text-center mb-2">Buat Akun Mahasiswa</h3>
                    <form action="/login/regis_mhssave" class="login-form" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <input type="text" class="form-control rounded-left" placeholder="NIM" name="nim" autofocus>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control rounded-left" placeholder="Tahun Masuk" name="tahun">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control rounded-left" placeholder="Prodi" name="prodi">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control rounded-left" placeholder="Nomor HP" name="no">
                        </div>
                        <div class="form-group">
