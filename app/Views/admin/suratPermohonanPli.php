...
<head>
    ...
    <title>Surat Permohonan PLI</title>
</head>
        ...
        <div class="card-body">
            ...
            <div class="container">
                    ...
                    <div class="col col-12">
                        <table class=" ms-2">
                            <tbody>
                                ...
                                <tr>
                                    <td>Hal</td>
                                    <td>: Permohonan Pengalaman Lapangan Industri Mahasiswa FPP UNP</td>
                                    <td></td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="row mt-3">
                    <div class="col col-12">
                        <p class="d-inline">
                            Kepada Yth : Pimpinan Campago Resort Hotel Bukittinggi
                        </p>
                ...
                <div class="row mt-2">
                    <div class="col col-12">
                        ...
                        <p class="mt-1" style="text-align:justify;"> &ensp;&ensp;&ensp;&ensp;&ensp;
                            Dalam rangka pelaksanaan program akademik mahasiswa Jurusan Ilmu Kesejahteraan
                            Keluarga Fakultas Pariwisata dan perhotelan Universitas Negeri Padang, kami bermaksud
                            mengirimkan mahasiswa untuk melaksanakan kegiatan Pengalaman Lapangan Industri (PLI) di
                            <b><?= $perusahaan; ?></b>
                        </p>
                        <p class="mt-1" style="text-align:justify;"> &ensp;&ensp;&ensp;&ensp;&ensp;
                            Kegiatan Pengalaman Lapangan Industri (PLI) merupakan kegiatan akademik untuk
                            membekali mahasiswa dengan wawasan bersifat praktis yang diharapkan dapat diperoleh
                            melalui kegiatan pengalaman lapangan industri/tempat kerja ini.
                        </p>
                        <p class="mt-1" style="text-align:justify;">&ensp;&ensp;&ensp;&ensp;&ensp;
                            Untuk itu kami bermohon kiranya Pimpinan <b><?= $perusahaan; ?></b> , untuk
                            dapat menerima mahasiswa kami melakukan kegiatan PLI tersebut mulai tanggal,
                            <b><?= $masuk; ?> s/d <?= $keluar; ?></b> . Mahasiswa tersebut adalah:
                        </p>
                        <table class="table-bordered text-center" style="border-color:black; color:black;">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="width: 200px;">Departemen</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $i = 1; ?>
                        ...
                        <p style="text-align:justify;" class="d-inline">&ensp;&ensp;&ensp;&ensp;&ensp;
                            Demikianlah surat ini dibuat, atas perhatian, bantuan, dan kerjasama Saudara kami ucapkan terima kasih.
                        </p>
                    </div>
                </div>
                <div class="row">
